...
//         Atten().updateData(userId!, formattedDate, timein);
//         final bool isExist = await Atten().checkUserIdExists(userId);
//         await prefs.setBool('isExist', isExist);
//         EHelperFunctions.showSnackBar(context, 'Login Successful');
//         reslut = true;
//         if (reslut == true) {
//           EHelperFunctions.showSnackBar(context, " Logged in at $timein");
//         } else {
